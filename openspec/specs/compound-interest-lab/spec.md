# compound-interest-lab Specification

## Purpose
finsight's first browser simulation: an interactive parameter sandbox that makes
exponential growth visible. Sliders drive one animated curve plus a live balance
breakdown, with real-vs-nominal (inflation-adjusted) values, honest defaults, and
